...
const statusRecords_1 = require("../database/repository/statusRecords");
const custom_1 = require("../utils/custom");
let StatusService = class StatusService {
    constructor(statusRepo, recordRepo, choicesRepo, srRepo) {
    ...
    solveProblem(solveInfo) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.srRepo.save(rateToSave);
            return {
                id,
                selectionRate,
            };
...
StatusService = __decorate([
    ...
    __metadata("design:paramtypes", [solveStatus_1.SolveStatusRepository,
        ...
        statusRecords_1.StatusRecordsRepository])
], StatusService);
